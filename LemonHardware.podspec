...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/docusingndev112/LemonHardware'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'docusingndev112' => 'jairnidom@gmail.com' }
  s.source           = { :git => 'https://github.com/docusingndev112/LemonHardware.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.platform = :osx
  s.osx.deployment_target = "13"

  s.source_files = 'LemonHardware/Classes/**/*'

  # s.resource_bundles = {
  #   'LemonHardware' => ['LemonHardware/Assets/*.png']
  # }
